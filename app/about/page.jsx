...
const AboutPage = () => {
  return (
    <>
      <SEO
        title="About Us | Abronia Lizards - Expert Reptile Breeders"
        description="Learn about our passion for Abronia lizards and commitment to responsible breeding. Discover our story, expertise, and dedication to arboreal reptile conservation."
