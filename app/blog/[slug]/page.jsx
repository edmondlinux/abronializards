...
const BlogPost = () => {
    ...
    if (error || !blogPost) {
        return (
            <>
                <SEO
                  title="Blog Post Not Found | Abronia Lizards"
                  description="Sorry, this blog post could not be found. Explore expert reptile care guides and Abronia lizard news."
                  canonical={`https://abronializards.com/blog/${params.slug}`}
                  url={`https://abronializards.com/blog/${params.slug}`}
                />
                <div className="min-h-screen flex items-center justify-center">
    ...
    // SEO values
    const blogUrl = `https://abronializards.com/blog/${params.slug}`;
    const blogImage = blogPost.featuredImage || 'https://abronializards.com/default-blog-image.png';
    const blogTitle = `${blogPost.title} | Abronia Lizards Blog`;
    const blogDescription = blogPost.excerpt || blogPost.description || 'Expert reptile care guides, news, and tips for Abronia lizard keepers.';
