...
const ProductCard = ({ product }) => {
    ...
    const handleCardClick = (e) => {
        ...
        // For non-link navigation fallback
    ...
    if (!mounted) {
        // Render without interactive features during SSR
        return (
            <div className="flex flex-col items-start gap-1 max-w-[200px] w-full">
    ...
    return (
        <>
            <Link
                href={productUrl}
                ref={cardRef}
                className="flex flex-col items-start gap-1 max-w-[200px] w-full block no-underline cursor-pointer"
            ...
            >
                <div className="relative bg-gradient-to-br from-gray-50 to-gray-100 rounded-xl w-full h-52 flex items-center justify-center overflow-hidden shadow-sm">
                    ...
                    <button 
                        ...
                        className="absolute top-3 right-3 bg-white/90 backdrop-blur-sm p-2 rounded-full shadow-lg transition-all duration-200 z-10"
                ...
                <div className="w-full space-y-1 pt-1">
                    ...
                    <div className="flex items-end justify-between w-full mt-2">
                        ...
                        <button 
                            ...
                            className="max-sm:hidden px-4 py-1.5 text-gray-700 bg-gray-50 border border-gray-200 rounded-full text-xs font-medium shadow-sm z-10"
                            data-interactive="true"
                            type="button"
                        >
                            Buy now
            ...
            {showPreview && mounted && (
                <div 
                    className="fixed z-50 bg-gray-900 text-white px-3 py-2 rounded-lg shadow-xl max-w-xs pointer-events-auto"
                    style={{
                        left: Math.max(10, Math.min(previewPosition.x, window.innerWidth - 300)),
                        top: Math.max(10, previewPosition.y),
                ...
                >
                    ...
                    <div className="flex items-center gap-2 text-xs text-gray-300 border-t border-gray-700 pt-2">
                        <span className="truncate flex-1 font-mono">{getFullUrl()}</span>
                        <button
                            onClick={copyLink}
